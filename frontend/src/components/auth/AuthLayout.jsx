        ...
        <div className="bg-[#fafafa] p-14 flex flex-col justify-between">
          ...
          <div>
            ...
            <p className="text-gray-500 text-2xl mt-8 leading-10">
              Discover top products, exclusive offers, and the best shopping
              experience.
            </p>
          ...
          <div className="grid grid-cols-3 gap-5 mt-10">
            <div className="bg-[#fff3ec] rounded-2xl p-5 text-center">
              ...
              <p className="text-xs text-gray-400 mt-1">100% secure payment</p>
            </div>

            <div className="bg-[#fff3ec] rounded-2xl p-5 text-center">
              <h3 className="font-semibold text-sm">Fast Delivery</h3>

              <p className="text-xs text-gray-400 mt-1">Quick & reliable</p>
            </div>

            <div className="bg-[#fff3ec] rounded-2xl p-5 text-center">
              <h3 className="font-semibold text-sm">Best Quality</h3>

              <p className="text-xs text-gray-400 mt-1">Original products</p>
            </div>
          </div>
        </div>
